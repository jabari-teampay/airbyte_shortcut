...
class SourceShortcut(AbstractSource):
    ...
    def streams(self, config: Mapping[str, Any]) -> List[Stream]:
        ...
        ,Stories11(start_date="2022-04-01", end_date="2022-05-26", auth=config["api_token"])
        ,Stories12(start_date="2022-05-27", end_date="2022-07-30", auth=config["api_token"])
        ,Stories13(start_date="2022-07-31", end_date="2022-09-30", auth=config["api_token"])
        ,Stories14(start_date="2022-10-01", end_date="2022-12-01", auth=config["api_token"])
