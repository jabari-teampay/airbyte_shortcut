...
import pytest
from source_shortcut.source import ShortcutStream


@pytest.fixture
def patch_base_class(mocker):
    # Mock abstract methods to enable instantiating abstract class
    mocker.patch.object(ShortcutStream, "path", "v0/example_endpoint")
    mocker.patch.object(ShortcutStream, "primary_key", "test_primary_key")
    mocker.patch.object(ShortcutStream, "__abstractmethods__", set())
